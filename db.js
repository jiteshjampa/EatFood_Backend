...
const mongourl =
  "mongodb+srv://tejesh:VijPad6972@cluster0.ycbrzpc.mongodb.net/EatFood?retryWrites=true&w=majority";
...
const mongodb = async () => {
  await mongoose
    ...
    .then(async () => {
      ...
      const fetchdatas = await mongoose.connection.db.collection(
        "category-items"
      );
